  ...
  return (
    ...
    <div className="container mx-auto mt-6 flex flex-col gap-8 max-md:gap-6 max-md:px-3 lg:flex-row">
        <div className="flex-1">
          <h1 className="text-4xl font-bold text-black max-md:text-2xl">Explore the <span className="text-transparent bg-clip-text bg-linear-65 from-orange-500 via-pink-500 to-violet-500">Technologies</span></h1>
